...
class Factory:
    ...
    def purchase(self, name, type, color):
        ...
        print("Закупка сырья для игрушки: \"{}\" тип: \"{}\" цвет: \"{}\"".format(self.new_toy.toy_name, self.new_toy.toy_type, self.new_toy.toy_color))
    def sewing(self):
        print("Пошив игрушки ...")
    def paint(self):
        print("Окраска игрушки ...")
    def ready_toy(self):
        print("Игрушка готова: название: \"{}\", тип: \"{}\", цвет: \"{}\"".format(self.new_toy.toy_name, self.new_toy.toy_type, self.new_toy.toy_color))
...
factory_star.purchase("Хрюша", 1, "розовый")
factory_star.sewing()
factory_star.paint()
factory_star.ready_toy()
...
class Factory:
    ...
    def purchase(self, name, type, color):
        ...
        print("Закупка сырья для игрушки: \"{}\" тип: \"{}\" цвет: \"{}\"".format(self.new_toy.toy_name, type, self.new_toy.toy_color))
    def sewing(self):
        print("Пошив игрушки ...")
    def paint(self):
        print("Окраска игрушки ...")
    def ready_toy(self):
        print("Игрушка готова: название: \"{}\", тип: \"{}\", цвет: \"{}\"".format(self.new_toy.toy_name, self.type, self.new_toy.toy_color))
